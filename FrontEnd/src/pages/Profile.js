   ...
   <>
    ...
    <div className="ProSel-box">
        ...
        <button className="btn-button1" onClick={()=> navigate("/StudentProfile")}>Submit</button>
            ...
            <div className="ProSel-middle">
        <div className="ProSel-middle-content">
        ...
        <div className="ProSel-right-side-content">
          <h1 className="selection-header-text1">Appointments Avaialability</h1>
          <button className="btn-button1" onClick={()=> navigate("/AppointmentCheck")}>Check</button><br />
          </div>
        </div>
      </div>
      <Footer />
